 ...
 * The type Colour.
 */
public class Colour extends AndroidColor {
    ...
    /**
     * Creates an int[] of 4 Colors that complement the AndroidColor.
     *
    ...
    public static int[] analagousColors(float[] hsv) {
        ...
        return new int[]{AndroidColor.HSVToColor(CA1), AndroidColor.HSVToColor(CA2),
                AndroidColor.HSVToColor(CB1), AndroidColor.HSVToColor(CB2)};
    }
